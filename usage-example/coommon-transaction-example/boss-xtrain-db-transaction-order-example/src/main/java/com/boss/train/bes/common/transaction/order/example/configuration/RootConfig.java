package com.boss.train.bes.common.transaction.order.example.configuration;
...
@MapperScan(basePackages = "com.boss.train.bes.common.transaction.order.example.dao")
@Configuration
