package com.boss.train.bes.common.transaction.user.example.configuration;
...
@MapperScan(basePackages = "com.boss.train.bes.common.transaction.user.example.dao")
@Configuration
