...
public enum BusinessError {
     ...
     * 系统管理 在线用户管理模块异常码
     */
    SYSTEM_MANAGER_ONLINE_REPEAT_ERROR("220801","在线用户信息已存在"),
    SYSTEM_MANAGER_ONLINE_INSERT_ERROR("220802","新增在线用户信息失败"),
    SYSTEM_MANAGER_ONLINE_DELETE_ERROR("220803","删除在线用户信息失败"),
    SYSTEM_MANAGER_ONLINE_UPDATE_ERROR("220804","更新在线用户信息失败"),
    SYSTEM_MANAGER_ONLINE_QUERY_ERROR("220805","查询在线用户信息失败"),
