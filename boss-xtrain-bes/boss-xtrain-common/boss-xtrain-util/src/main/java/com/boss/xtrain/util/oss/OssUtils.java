...
import com.boss.xtrain.util.MyFileUtils;
...
public class OssUtils {
    ...
    public static OSSClient getOSSClient(){
        return new OSSClient(OssConstant.END_POINT,OssConstant.KEY_ID, OssConstant.KEY_SECRET);
    }
    ...
    public static  String getContentType(String fileName){
        //文件的后缀名
        String fileExtension = fileName.substring(fileName.lastIndexOf(dOT));
